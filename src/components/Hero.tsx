      ...
      {heroLayout === "centered" && (
        ...
        >
          <div className="max-w-2xl mx-auto flex flex-col gap-6">
            ...
            <h1 style={{ color: "var(--hc-primary-dark)" }} className="font-serif italic text-4xl sm:text-5xl font-normal leading-snug">{hero.heading}</h1>
        ...
        >
          <div className={`max-w-5xl mx-auto flex min-h-[540px] ${photoLeft ? "sm:flex-row-reverse" : ""}`}>
            <div className="flex flex-col justify-center py-20 px-8 gap-5 flex-1">
              ...
              <h1 style={{ color: "var(--hc-primary-dark)" }} className="font-serif italic text-4xl font-normal leading-snug">{hero.heading}</h1>
